...
def main(config, args):
    ...
    load_model_dir = os.path.join("new_saved", args.load_model_dir); state_dict = None
    ...
    if args.model_interpolate:
        model_start_dir = os.path.join("new_saved", args.model_interpolate_start)
        model_end_dir = os.path.join("new_saved", args.model_interpolate_end)
    ...
    for run in range(args.runs):
        ...
        # Train
        checkpoint_dir = os.path.join("new_saved", 
