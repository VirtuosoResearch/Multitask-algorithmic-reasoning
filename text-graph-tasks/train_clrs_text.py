...
if __name__ == "__main__":
    ...
    for run in range(args.runs):
        ...
        if args.epochs > 0:
            if args.use_graph_llama or args.train_lora or args.train_branching_lora or args.train_adapter or \
        ...
        if args.use_graph_llama or args.train_lora or args.train_branching_lora or args.train_adapter:
