...
insertion_sort = np.array([0, 65.70, 79.78, 91.83, 99.99, 99.99, 99.99, 99.99])
...
ax2.set_title(r'$\mathrm{Multiplication~}(m=5)$', fontsize = 32)
ax2.tick_params(labelsize=32)
ax2.grid(ls=':', lw=0.8)
plt.legend(fontsize=28, loc="lower right")

plt.tight_layout()
plt.savefig("./figures/sample_complexity_multiplication.pdf", format="pdf", dpi=1200)
plt.show()
