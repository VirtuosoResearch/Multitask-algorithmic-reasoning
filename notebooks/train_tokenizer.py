...
train_datasets = []
algorithms = ["dinic_wll"]
csv_dirs = ["dinic_data_10_40"]
...
wrapped_tokenizer.save_pretrained("./tokenizers/gpt2_dinic_wll")
# %%
tokenizer = AutoTokenizer.from_pretrained("./tokenizers/gpt2_dinic_wll", use_fast=True, padding_side="left")
# %%
