...
#     --model_key $model \
#     --devices 2 --batch_size 1 --inference_batch_size 1 --max_length 12000 --max_output_length 256 --generate_output --runs 1 --lr 5e-5 \
#     --save_name test --epochs 0 --precision "bf16-true" --evaluate_training_set --downsample 0.1 --minimum_samples 100 --minimum_samples_validation 32 \
#     --train_lora --lora_rank 4 --lora_alpha 32 --use_qlora

# python train_clrs_text.py --task_names "bfs" --prompt_styles "cot_few_shot_10"\
#     --model_key $model \
#     --devices 2 --batch_size 1 --inference_batch_size 1 --max_length 13000 --max_output_length 1024 --generate_output --runs 1 --lr 5e-5 \
#     --save_name test --epochs 0 --precision "bf16-true" --evaluate_training_set --downsample 0.1 --minimum_samples 100 --minimum_samples_validation 32 --evaluate_cot \
#     --train_lora --lora_rank 4 --lora_alpha 32 --use_qlora
# done
...
for model in "meta-llama/Llama-3.2-1B" "meta-llama/Llama-3.2-1B" 
do
python train_clrs_text.py --task_names "bellman_ford" --prompt_styles "few_shot_15"\
    --model_key $model \
    --devices 1 --batch_size 1 --inference_batch_size 1 --max_length 17000 --max_output_length 256 --generate_output --runs 1 --lr 5e-5 \
    --save_name test --epochs 0 --precision "bf16-true" --evaluate_training_set --downsample 0.1 --minimum_samples 100 --minimum_samples_validation 32 \
    --train_lora --lora_rank 4 --lora_alpha 32 --use_qlora

python train_clrs_text.py --task_names "bellman_ford" --prompt_styles "few_shot_20"\
    --model_key $model \
    --devices 1 --batch_size 1 --inference_batch_size 1 --max_length 22000 --max_output_length 256 --generate_output --runs 1 --lr 5e-5 \
    --save_name test --epochs 0 --precision "bf16-true" --evaluate_training_set --downsample 0.1 --minimum_samples 100 --minimum_samples_validation 32 \
    --train_lora --lora_rank 4 --lora_alpha 32 --use_qlora

python train_clrs_text.py --task_names "bellman_ford" --prompt_styles "few_shot_25"\
    --model_key $model \
    --devices 1 --batch_size 1 --inference_batch_size 1 --max_length 27000 --max_output_length 256 --generate_output --runs 1 --lr 5e-5 \
    --save_name test --epochs 0 --precision "bf16-true" --evaluate_training_set --downsample 0.1 --minimum_samples 100 --minimum_samples_validation 32 \
    --train_lora --lora_rank 4 --lora_alpha 32 --use_qlora

python train_clrs_text.py --task_names "bellman_ford" --prompt_styles "few_shot_25"\
    --model_key $model \
    --devices 1 --batch_size 1 --inference_batch_size 1 --max_length 32000 --max_output_length 256 --generate_output --runs 1 --lr 5e-5 \
    --save_name test --epochs 0 --precision "bf16-true" --evaluate_training_set --downsample 0.1 --minimum_samples 100 --minimum_samples_validation 32 \
    --train_lora --lora_rank 4 --lora_alpha 32 --use_qlora
done