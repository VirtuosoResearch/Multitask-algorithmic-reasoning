...
if __name__ == "__main__":
    ...
    for run in range(args.runs):
        ...
        if args.task_names[0] == 'gsm8k':
            data_module = GSM8KDataModule(
                    tokenizer=tokenizer,
        ...
        lm = MultitaskModel(model, tokenizer, model_type, use_cpu_offload=False,
                        ...
                        optimizer=args.optimizer, generate_output=args.generate_output, task_names=extended_task_names, eval_math=True)
