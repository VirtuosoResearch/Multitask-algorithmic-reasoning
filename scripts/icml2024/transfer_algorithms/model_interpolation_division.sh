...
python train_multitask.py --config configs/config.json \
    ...
    --model_interpolate \
    --model_interpolate_start gpt2_multiplication_digit_5_carry_True_layers_2_train_size_10000\
    --model_interpolate_end gpt2_division_digit_5_layers_2_train_size_5000_load_model\
