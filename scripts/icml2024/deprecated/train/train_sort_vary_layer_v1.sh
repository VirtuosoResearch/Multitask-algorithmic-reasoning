...
#     --lr 5e-4 --random_init --device 1 --num_layers 4 --tokenizer_dir gpt2_sort_100\
#     --train_size $size
# done
...
python train.py --config configs/config.json \
    --algorithm quick_sort --data_dir inter_results_length_5\
    --batch_size 256 --max_length 16 --num_of_instances 1000000 \
    --lr 5e-4 --random_init --device 1 --num_layers 8 --tokenizer_dir gpt2_sort_100\
    --train_size $size
done
...
python train.py --config configs/config.json \
    --algorithm quick_sort --data_dir inter_results_length_5\
    --batch_size 256 --max_length 16 --num_of_instances 1000000 \
    --lr 5e-4 --random_init --device 1 --num_layers 12 --tokenizer_dir gpt2_sort_100\
    --train_size $size
done
