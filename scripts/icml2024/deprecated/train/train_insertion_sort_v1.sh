...
python train.py --config configs/config.json \
    --algorithm insertion_sort --data_dir inter_results_length_5 \
    --batch_size 256 --max_length 16 --num_of_instances 1000000 --generate_length 5\
    --lr 5e-4 --random_init --device 3 --num_layers 2 --tokenizer_dir gpt2_sort_100\
...
#     --batch_size 256 --max_length 16 --num_of_instances 1000000 --generate_length 5\
#     --lr 5e-4 --random_init --device 3 --num_layers 2 --tokenizer_dir gpt2_sort_100\
#     --train_size 1000 --max_steps 10 --runs 1