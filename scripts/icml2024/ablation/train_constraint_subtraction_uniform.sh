...
python train_multitask.py --config configs/config.json \
    ...
    --lr 5e-3 --device 3 --num_layers 6 --random_init --tokenizer_dir gpt2_arithmetic\
    ...
    --train_constraint_allocation --reg_total $d --early_stop 200 --allocation_strategy uniform 
done