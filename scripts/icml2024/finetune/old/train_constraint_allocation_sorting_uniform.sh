...
python train.py --config configs/config.json \
    ...
    --train_constraint_allocation --reg_total $d --allocation_strategy uniform\
    --load_target --target_algorithm sorting --target_data_dir length_5 --target_generate_length 5 --runs 1 
done