...
# # %%
# task_affinities = np.array([
#     [0.9933, 0.9997, 0.9998, 1.0000],
#     [0.3356, 0.5583, 0.5208, 0.4774],
#     [0.8297, 0.8172, 0.8438, 0.8329],
#     [0.9259, 0.9061, 0.9469, 0.9608]
# ])
# # np.load('task_affinities_pairwise_youtube_10.npy')

# # %%
# # for k in np.arange(2):
# k = 3
# _, assignment = run_sdp_clustering(task_affinities, int(k))
# print(assignment)
